...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- launch rofi's application launcher
    , ((modm                 , xK_p     ), spawn "rofi -modi drun,ssh,window -show drun -show-icons")

    -- launch rofi's window switcher (puts xmonad focus on selected)
    , ((modm                 , xK_Tab   ), spawn "rofi -modi drun,ssh,window -show window -show-icons")
    ...
    -- mod-shift-{w,e,r}, Move window to screen 1, 2, or 3
    --
...
--
myLayout = avoidStruts $ tiled ||| Mirror tiled ||| Full ||| mouseResizableTile
  where
...
--
main = do
  xmproc <- spawnPipe "/home/deco/.config/xmonad/starttaffy.sh"
  -- docks for xmobar gap, ewmh for rofi window switcher
  xmonad $ ewmh $ docks $ pagerHints defaults
...
help = unlines ["The default modifier key is 'alt'. Default keybindings:",
    ...
    "mod-p            Launch rofi's dmenu replacement",
